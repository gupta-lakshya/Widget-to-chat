...
export function SectionCards() {
    ...
    return cn(
      ...
      isOpen
        ? isFocused
          ...
          : "opacity-30 scale-[0.97] blur-[0.5px] cursor-pointer hover:opacity-50 saturate-50"
        : "relative z-10"
    )
  }
  ...
  return (
    <div className="grid grid-cols-1 gap-4 px-4 lg:px-6 @xl/main:grid-cols-2 @5xl/main:grid-cols-4">
      ...
      <Card 
        className={getCardClass("Total Revenue")}
        onClick={() => handleCardClick("Total Revenue")}
      >
        <div className={cn("flex flex-col justify-between h-full w-full", isOpen && activeTopic !== "Total Revenue" && "pointer-events-none")}>
      ...
      <Card 
        className={getCardClass("Active Users")}
        onClick={() => handleCardClick("Active Users")}
      >
        <div className={cn("flex flex-col justify-between h-full w-full", isOpen && activeTopic !== "Active Users" && "pointer-events-none")}>
          <CardHeader className="pb-2">
            <div className="flex items-center justify-between w-full">
              <div className="flex items-center gap-1.5">
                <button
      ...
      <Card 
        className={getCardClass("Traffic Sources")}
        onClick={() => handleCardClick("Traffic Sources")}
      >
        <div className={cn("flex flex-col justify-between h-full w-full", isOpen && activeTopic !== "Traffic Sources" && "pointer-events-none")}>
          <CardHeader className="pb-2">
            <div className="flex items-center justify-between w-full">
              <div className="flex items-center gap-1.5">
                <button
      ...
      {/* 4. Radar Chart */}
      <Card 
        className={getCardClass("Performance Index")}
        onClick={() => handleCardClick("Performance Index")}
      >
        <div className={cn("flex flex-col justify-between h-full w-full", isOpen && activeTopic !== "Performance Index" && "pointer-events-none")}>
          <CardHeader className="pb-2">
            <div className="flex items-center justify-between w-full">
              <div className="flex items-center gap-1.5">
                <button
